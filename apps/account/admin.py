...
class CustomUserAdmin(UserAdmin):
    ...
    search_fields=('email',)
    ordering=('email',)
    filter_horizontal=('user_permissions','groups')   #This filter_horizontal feature is for the admin to change the access to different users in the same place where they enter the user information.
    
    
    def change_view(self, request, object_id, form_url='', extra_context=None):  #This function is to limit the access of admins to each other
